...
//=========================================================
		$("#addActivity").on("click", function(){
		 ...
		 var dayTrip = {
			...
			database.ref('/day_trip').set(dayTrip)/*Is this correct, does that forward slash need to be there?*/
			database.ref('/weekend_trip').push(dayTrip)
			database.ref('/long_trip').push(dayTrip)
